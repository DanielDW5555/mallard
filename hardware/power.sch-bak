...
Wire Wire Line
	2600 3850 2600 4100
$Comp
L mallard-rescue:GND-power #PWR048
U 1 1 61012D81
P 2400 4600
F 0 "#PWR048" H 2400 4350 50  0001 C CNN
...
$EndComp
$Comp
L mallard-rescue:GND-power #PWR059
U 1 1 6101361F
P 9750 3850
F 0 "#PWR059" H 9750 3600 50  0001 C CNN
...
$Comp
L mallard-rescue:GND-power #PWR050
U 1 1 61016863
P 6150 3600
...
$EndComp
$Comp
L mallard-rescue:GND-power #PWR051
U 1 1 61017055
P 6900 4600
...
Wire Wire Line
	6150 3450 6150 3600
$Comp
L mallard-rescue:LED-Device D4
U 1 1 61018DA7
P 5000 3400
F 0 "D4" H 4993 3617 50  0000 C CNN
...
SOLAR_PANEL
$Comp
L mallard-rescue:GND-power #PWR046
U 1 1 61032ED8
P 950 4600
F 0 "#PWR046" H 950 4350 50  0001 C CNN
...
$EndComp
$Comp
L mallard-rescue:GND-power #PWR047
U 1 1 610332ED
P 2100 3650
...
Wire Wire Line
	6900 3000 7300 3000
$Comp
L mallard-rescue:GND-power #PWR055
U 1 1 6103D3F7
P 7900 3500
...
$Comp
L mallard-rescue:R-Device R13
U 1 1 615B9F1A
P 4250 3750
F 0 "R13" H 4320 3796 50  0000 L CNN
...
$EndComp
$Comp
L mallard-rescue:R-Device R14
U 1 1 615BC28F
P 4600 3150
F 0 "R14" H 4670 3196 50  0000 L CNN
...
U 1 1 615BF8BC
P 7900 3250
F 0 "C13" H 8015 3296 50  0000 L CNN
...
U 1 1 615C05A8
P 9900 3350
F 0 "C15" H 10015 3396 50  0000 L CNN
F 1 "1uF" H 10015 3305 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.08x0.95mm_HandSolder" H 9938 3200 50  0001 C CNN
F 3 "http://weblib.samsungsem.com/mlcc/mlcc-ec-data-sheet.do?partNumber=CL10B105KO8NNN" H 9900 3350 50  0001 C CNN
F 4 "1276-1019-1-ND" H 9900 3350 50  0001 C CNN "Digikey"
	1    9900 3350
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 615C2AA1
P 2600 4250
F 0 "R12" H 2670 4296 50  0000 L CNN
...
$EndComp
$Comp
L mallard-rescue:+3V3-power #PWR052
U 1 1 615C2F4F
P 7300 2950
F 0 "#PWR052" H 7300 2800 50  0001 C CNN
...
$EndComp
$Comp
L mallard:BQ24210DQCT U8
U 1 1 615C38E5
P 3500 2900
F 0 "U8" H 3500 3025 50  0000 C CNN
...
U 1 1 615C529F
P 9250 2900
F 0 "U10" H 9250 3025 50  0000 C CNN
...
U 1 1 615C9973
P 4250 4150
F 0 "TH1" V 4008 4150 50  0000 C CNN
F 1 "103AT" V 4099 4150 50  0000 C CNN
F 2 "Resistor_THT:R_Axial_DIN0204_L3.6mm_D1.6mm_P2.54mm_Vertical" H 4250 4150 50  0001 C CNN
...
Wire Wire Line
	8900 3200 8800 3200
$Comp
L mallard-rescue:-3V3-power #PWR063
U 1 1 6161FA5E
P 11000 3000
F 0 "#PWR063" H 11000 3100 50  0001 C CNN
...
$EndComp
$Comp
L mallard-rescue:GND-power #PWR058
U 1 1 615BBB45
P 9600 5250
F 0 "#PWR058" H 9600 5000 50  0001 C CNN
...
U 1 1 615C2667
P 9050 4350
F 0 "U9" H 9050 4515 50  0000 C CNN
F 1 "TPS71710DRVR" H 9050 4424 50  0000 C CNN
F 2 "Package_SON:WSON-6-1EP_2x2mm_P0.65mm_EP1x1.6mm" H 9000 4800 50  0001 C CNN
...
F 4 "296-22984-1-ND" H 9050 4350 50  0001 C CNN "Digikey"
	1    9050 4350
	1    0    0    -1  
$EndComp
$Comp
L mallard-rescue:GND-power #PWR060
U 1 1 615C9273
P 10100 5250
F 0 "#PWR060" H 10100 5000 50  0001 C CNN
...
$EndComp
$Comp
L mallard-rescue:+1V0-power #PWR062
U 1 1 615CDF04
P 10800 4400
F 0 "#PWR062" H 10800 4250 50  0001 C CNN
...
$EndComp
$Comp
L mallard-rescue:R_Small-Device R18
U 1 1 615D2E50
P 10450 4450
F 0 "R18" V 10254 4450 50  0000 C CNN
...
$EndComp
$Comp
L mallard-rescue:+3V3-power #PWR054
U 1 1 615DFBEC
P 7750 4400
...
DNI VDPM Resistor
$Comp
L mallard-rescue:R-Device R15
U 1 1 615E6A6B
P 5250 3150
F 0 "R15" H 5320 3196 50  0000 L CNN
...
U 1 1 619186D3
P 7900 4650
F 0 "C14" H 8015 4696 50  0000 L CNN
...
$EndComp
$Comp
L mallard-rescue:R-Device R16
U 1 1 61925061
P 9600 4600
F 0 "R16" H 9670 4646 50  0000 L CNN
...
Wire Wire Line
	7900 4800 7900 4850
$Comp
L mallard-rescue:GND-power #PWR056
U 1 1 6193F3E7
P 7900 4850
F 0 "#PWR056" H 7900 4600 50  0001 C CNN
...
$Comp
L mallard-rescue:C-Device C16
U 1 1 619438C1
P 10100 4650
F 0 "C16" H 10215 4696 50  0000 L CNN
...
Wire Wire Line
	7300 3000 7300 2950
$Comp
L mallard-rescue:+3V3-power #PWR053
U 1 1 61970B46
P 7750 2950
F 0 "#PWR053" H 7750 2800 50  0001 C CNN
...
$Comp
L mallard-rescue:GND-power #PWR061
U 1 1 619CB529
P 10350 3600
F 0 "#PWR061" H 10350 3350 50  0001 C CNN
...
$Comp
L mallard-rescue:C-Device C17
U 1 1 619CB531
P 10350 3350
F 0 "C17" H 10465 3396 50  0000 L CNN
...
U 1 1 619D13FF
P 2100 3250
F 0 "C11" H 2215 3296 50  0000 L CNN
...
$Comp
L mallard-rescue:GND-power #PWR049
U 1 1 619EC3D6
P 4250 4600
F 0 "#PWR049" H 4250 4350 50  0001 C CNN
...
U 1 1 61A122D5
P 4350 3300
F 0 "D3" H 4343 3517 50  0000 C CNN
...
Wire Wire Line
	9400 5100 9350 5100
$Comp
L mallard-rescue:GND-power #PWR057
U 1 1 61EB71F9
P 9400 5250
F 0 "#PWR057" H 9400 5000 50  0001 C CNN
